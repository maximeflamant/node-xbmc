...
(function() {
  ...
  XbmcApi = (function() {
    ...
    XbmcApi.prototype.once = function(evt, callback) {
      return pubsub.once(evt, callback);
    };
    ...
    XbmcApi.prototype.removeAllListeners = function(evt) {
      return pubsub.removeAllListeners(evt);
    };
